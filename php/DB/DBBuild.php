...
"CREATE TABLE PCEndorsement
(PCENDORSEMENTID smallint NOT NULL AUTO_INCREMENT,
PCNAME varchar(128),
PCDATE date,
PCENDORSEMENT varchar (4096),
PRIMARY KEY(PCENDORSEMENTID))",
