...
{		
	...
	function SiteBuildObject($SiteName = "default", $SiteDirectory = "current", $SourceName = "c:/wamp/www/PHPSite/")
	{
		if($SiteDirectory == "current"){
			$this->setTargetDirectoryName ($this->getRealCurrentDirectoryName());
			}
		else {
			$this->setTargetDirectoryName ($SiteDirectory);
			}
...
function printSiteBuild(){
	...
	echo "<br>++++++++++ SITE BUILD ++++++++++";
	echo "<br>================================";
	echo "<br>Site Name: " . $this->getSiteName();
...
function buildSiteStructure(){		
	...
	$this->createDirectory($SiteName . "/php/DB");
...
#####################################################################
#SiteBuildTest("SiteName", "TargetDirectory", "SourceDirectory")	#
#@effect: test harness...											#
#####################################################################
function SiteBuildTest(){
	// current: source
	$dO = new SiteBuildObject("RebSam02","c:/wamp/www/RebSam01", "c:/wamp/www/PHPSite");
	$dO->printSiteBuild();
